...
{
public:
  DRV89xxMotor() : DRV89xxMotor(0, 0, 0, 0, false){};
  DRV89xxMotor(byte hb1, byte hb2, byte pwm_channel, byte reverse_delay, bool free_wheeling);
...
private:
  ...
  bool _free_wheeling = false; // free wheeling activates active reverse current flow trough inactive MosFET
